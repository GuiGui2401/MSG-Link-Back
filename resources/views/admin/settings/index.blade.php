        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6" x-data="{ activeTab: 'payment' }">
            <div class="border-b border-gray-200">
                <nav class="flex -mb-px overflow-x-auto" aria-label="Tabs">
                    ...
                    <button type="button" @click="activeTab = 'monetization'"
                            :class="activeTab === 'monetization' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                            class="whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm transition-colors">
                        <i class="fas fa-coins mr-2"></i>Monétisation
                    </button>
            ...
            <div class="p-6">
                ...
                <div x-show="activeTab === 'monetization'" x-cloak>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach($monetizationSettings as $setting)
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                {{ $setting->description }}
                            </label>
                            ...
                            <div class="relative">
                                ...
                                <span class="absolute right-3 top-2.5 text-gray-500 text-sm">%</span>
                                @elseif(str_contains($setting->key, 'amount') || str_contains($setting->key, 'payout'))
                                <span class="absolute right-3 top-2.5 text-gray-500 text-sm">FCFA</span>
                                @endif
                            </div>
                            @endif
                    ...
                    <div class="mt-4 p-4 bg-emerald-50 border-l-4 border-emerald-400 rounded">
                        <p class="text-sm text-emerald-700">
                            <i class="fas fa-coins mr-2"></i>
                            Règles économiques pour Creator Fund et partage des revenus publicitaires.
                        </p>
                    </div>
                </div>
