...
@section('title', 'Nouvelle Page Légale')
@section('header', 'Créer une Page Légale')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    @error('slug')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">URL de la page: /legal/<span id="slug-preview">slug</span></p>
                </div>
            </div>
